...
saveRDS(modelchoice$p[modelchoice$method == "bh"], file = "./data_model_prob/bh_model_prob.rds")
saveRDS(modelchoice$p[modelchoice$method == "rk"], file = "./data_model_prob/rk_model_prob.rds")
saveRDS(modelchoice$p[modelchoice$method == "hs"], file = "./data_model_prob/hs_model_prob.rds")
